...
- (void)configBackgroundScrollView {
    ...
    [self.backgroundScrollView mas_makeConstraints:^(MASConstraintMaker *make) {
     ...
     CGFloat backgroundScrollViewHeight = MainScreenHeight;
    self.backgroundScrollView.contentSize = CGSizeMake(MainScreenWidth, backgroundScrollViewHeight);
    ...
    self.contentLabel = [[UILabel alloc] initWithFrame:CGRectMake(5, lineView2.y + lineView2.height + 5 - 20, MainScreenWidth - 10, backgroundScrollViewHeight - lineView2.y - lineView2.height - 5)];
...
- (void)clickContactSellerButtonDone {
    ...
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"请选择客服" message:nil preferredStyle:UIAlertControllerStyleActionSheet];
    
    NSArray *messageArray = @[@"联系QQ1:97145222", @"联系QQ2:97148222", @"联系微信:18922831800",  @"联系电话:18922831800"];
        ...
        UIAlertAction *action = [UIAlertAction actionWithTitle:messageArray[i] style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
            ...
            if (i == 0) {
               ...
               NSString  *qqNumber = @"97148222";
                ...
                pastboard.string = @"18922831800";
                CustomWrongMessage(@"微信已经复制，请到微信去添加");
            } else if (i == 3) {
                NSString *string = @"telprompt://18922831800";
